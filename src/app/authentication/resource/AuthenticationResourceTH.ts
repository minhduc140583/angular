const AuthenticationResourceTH = {
  status_away: 'Away',
  ...
  placeholder_placeholder_username: 'Enter your username',
  placeholder_password: 'Enter your password',
  placeholder_passcode: 'Enter your passcode',
  ...
  button_forgot_password: 'Send a code to reset password',
  ...
  fail_sign_up_username_existed: 'This email is registered already or the email format is invalid.',
  fail_sign_up_email_existed: 'This email is registered already or the email format is invalid.',
...
export default AuthenticationResourceTH;
